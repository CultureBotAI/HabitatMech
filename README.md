...
**3,221 habitat records** are currently committed.

| Category | Records | | Grounding | Records |
|---|---:|---|---|---:|
| HOST_ASSOCIATED | 1,640 | | EXACT | 1,064 |
| ENGINEERED | 485 | | UNGROUNDED | 979 |
| AQUATIC | 468 | | NARROW | 978 |
| TERRESTRIAL | 353 | | NOT_APPLICABLE | 97 |
| OTHER | 204 | | CLOSE | 91 |
| FOOD | 60 | | BROAD | 12 |
| AIR | 7 | |  |  |
| CLINICAL | 4 | |  |  |

168 records are attested by at least two sources; 16 are attested by four or more.

**661 records (20.5%) are `REVIEWED`;** the remaining 2,560 are `SEEDED`.
