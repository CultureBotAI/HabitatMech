...
**3,213 habitat records** are currently committed.

| Category | Records | | Grounding | Records |
|---|---:|---|---|---:|
| HOST_ASSOCIATED | 1,650 | | EXACT | 1,063 |
| ENGINEERED | 485 | | UNGROUNDED | 961 |
| AQUATIC | 468 | | NARROW | 983 |
...
174 records are attested by at least two sources; 16 are attested by four or more.

**684 records (21.3%) are `REVIEWED`;** the remaining 2,529 are `SEEDED`.
