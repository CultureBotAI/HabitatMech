...
**3,217 habitat records** are currently committed.

| Category | Records | | Grounding | Records |
|---|---:|---|---|---:|
| HOST_ASSOCIATED | 1,638 | | EXACT | 1,063 |
| ENGINEERED | 485 | | UNGROUNDED | 964 |
...
171 records are attested by at least two sources; 16 are attested by four or more.

**686 records (21.3%) are `REVIEWED`;** the remaining 2,531 are `SEEDED`.
