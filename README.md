...
**3,207 habitat records** are currently committed.

| Category | Records | | Grounding | Records |
|---|---:|---|---|---:|
| HOST_ASSOCIATED | 1,649 | | EXACT | 1,060 |
| ENGINEERED | 487 | | UNGROUNDED | 955 |
...
177 records are attested by at least two sources; 16 are attested by four or more.

**684 records (21.3%) are `REVIEWED`;** the remaining 2,523 are `SEEDED`.
