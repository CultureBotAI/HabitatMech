...
**3,210 habitat records** are currently committed.

| Category | Records | | Grounding | Records |
|---|---:|---|---|---:|
| HOST_ASSOCIATED | 1,649 | | EXACT | 1,063 |
| ENGINEERED | 487 | | UNGROUNDED | 957 |
...
175 records are attested by at least two sources; 16 are attested by four or more.

**682 records (21.2%) are `REVIEWED`;** the remaining 2,528 are `SEEDED`.
