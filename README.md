...
**3,216 habitat records** are currently committed.
...
172 records are attested by at least two sources; 16 are attested by four or more.

**685 records (21.3%) are `REVIEWED`;** the remaining 2,531 are `SEEDED`.
