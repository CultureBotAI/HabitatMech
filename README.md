...
**3,222 habitat records** are currently committed.

| Category | Records | | Grounding | Records |
|---|---:|---|---|---:|
| HOST_ASSOCIATED | 1,641 | | EXACT | 1,064 |
| ENGINEERED | 485 | | UNGROUNDED | 980 |
...
**662 records (20.5%) are `REVIEWED`;** the remaining 2,560 are `SEEDED`.
