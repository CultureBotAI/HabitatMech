...
**3,218 habitat records** are currently committed.

| Category | Records | | Grounding | Records |
|---|---:|---|---|---:|
| HOST_ASSOCIATED | 1,638 | | EXACT | 1,063 |
| ENGINEERED | 485 | | UNGROUNDED | 965 |
| AQUATIC | 468 | | NARROW | 979 |
| TERRESTRIAL | 353 | | NOT_APPLICABLE | 107 |
| OTHER | 204 | | CLOSE | 92 |
| FOOD | 60 | | BROAD | 12 |
| AIR | 7 | |  |  |
| CLINICAL | 3 | |  |  |

170 records are attested by at least two sources; 16 are attested by four or more.

**687 records (21.3%) are `REVIEWED`;** the remaining 2,531 are `SEEDED`.
