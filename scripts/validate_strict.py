#!/usr/bin/env python3
"""Strict LinkML validation harness for HabitatMech instance records.
...
HabitatMech has a single root class (HabitatRecord); no class routing required.
"""
...
SCHEMA_PATH = _REPO_ROOT / "src" / "habitatmech" / "schema" / "habitatmech.yaml"
DEFAULT_ROOTS = [_REPO_ROOT / "data" / "habitats"]
TARGET_CLASS = "HabitatRecord"
...
def main() -> int:
    ...
    parser.add_argument("paths", nargs="*", type=Path,
                        help="Files or directories. Defaults to data/habitats/.")
